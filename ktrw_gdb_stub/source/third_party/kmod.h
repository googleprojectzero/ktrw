// This file is from Xcode 11.2.1 (11B500), at the path
...
struct  kmod_info;
typedef int kmod_start_func_t(struct kmod_info * ki, void * data);
typedef int kmod_stop_func_t(struct kmod_info * ki, void * data);
...
typedef struct kmod_info {
	...
	uint64_t            hdr_size;           // unwired hdr size
